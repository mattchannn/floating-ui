  ...
  return (
    ...
    >
      <div>
        ...
        <h3>Dropdown Menu</h3>
        <FloatingTree>
          <Menu label="File" id="root">
            <MenuItem label="New tab" />
            <MenuItem label="New window" />
            <Menu label="New file..." id="new file">
              <MenuItem label="Mail" />
              <MenuItem label="Instagram" />
            </Menu>
            <Menu label="More options..." id="more options...">
              <MenuItem label="Mail" />
              <MenuItem label="Instagram" />
              <Menu label="Other..." id="other...">
        ...
        <h3>Dialog</h3>
        <Dialog
          render={({close, titleId, descriptionId}) => (
            <div>
              <h1 id={titleId}>This is a dialog!</h1>
              <p id={descriptionId}>Please accept the terms...</p>
              <button onClick={close}>Close</button>
            </div>
          )}
        >
